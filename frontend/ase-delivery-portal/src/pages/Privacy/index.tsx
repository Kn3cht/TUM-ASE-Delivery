...
const Privacy: FC = () => {
  return (
    <PageWrapper compact>
      <Card>
        <h1 className="adsimple-312398299">Datenschutzerklärung</h1>
        <h2 id="einleitung-ueberblick" className="adsimple-312398299">
          Einleitung und Überblick
        </h2>
        <p>
          Wir haben diese Datenschutzerklärung (Fassung 27.01.2023-312398299)
          verfasst, um Ihnen gemäß der Vorgaben der{" "}
          <a
            className="adsimple-312398299"
            href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=312398299#d1e2269-1-1"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <br />
          <strong className="adsimple-312398299">Kurz gesagt:</strong> Wir
        ...
        <p>
          ...
          technische{" "}
          <strong className="adsimple-312398299">
            Begriffe leserfreundlich erklärt
          </strong>
          , Links zu weiterführenden Informationen geboten und{" "}
          <strong className="adsimple-312398299">Grafiken</strong> zum Einsatz
        ...
        <h2 id="anwendungsbereich" className="adsimple-312398299">
          Anwendungsbereich
        </h2>
        <p>
        ...
        <ul className="adsimple-312398299">
          <li className="adsimple-312398299">
        ...
        <p>
          <strong className="adsimple-312398299">Kurz gesagt:</strong> Die
        ...
        <h2 id="rechtsgrundlagen" className="adsimple-312398299">
          Rechtsgrundlagen
        </h2>
        <p>
        ...
        <ol>
          <li className="adsimple-312398299">
            <strong className="adsimple-312398299">Einwilligung</strong>{" "}
          ...
          <li className="adsimple-312398299">
            <strong className="adsimple-312398299">Vertrag</strong> (Artikel 6
        ...
        <ul className="adsimple-312398299">
          <li className="adsimple-312398299">
            In <strong className="adsimple-312398299">Österreich</strong> ist
            dies das Bundesgesetz zum Schutz natürlicher Personen bei der
            Verarbeitung personenbezogener Daten (
            <strong className="adsimple-312398299">Datenschutzgesetz</strong>),
            kurz <strong className="adsimple-312398299">DSG</strong>.
          </li>
          <li className="adsimple-312398299">
            In <strong className="adsimple-312398299">Deutschland</strong> gilt
            das{" "}
            <strong className="adsimple-312398299">
              Bundesdatenschutzgesetz
            </strong>
            , kurz<strong className="adsimple-312398299"> BDSG</strong>.
          </li>
        </ul>
        <p>
        ...
        <h2 id="kontaktdaten-verantwortliche" className="adsimple-312398299">
        ...
        <p>
          ...
          <br />
          <span className="adsimple-312398299" style={{ fontWeight: 400 }}>
            Nobody
            <br />
            Munich, Germany
          </span>
          ...
          <a href="https://www.testfirma.de/impressum/">
            https://www.testfirma.de/impressum/
          </a>
        </p>
        <h2 id="rechte-dsgvo" className="adsimple-312398299">
        ...
        <p>
          <strong className="adsimple-312398299">Kurz gesagt:</strong> Sie haben
        ...
        <p>
          ...
          <a
            className="adsimple-312398299"
            href="https://www.dsb.gv.at/?tid=312398299"
            target="_blank"
            rel="noreferrer"
          >
            https://www.dsb.gv.at/
